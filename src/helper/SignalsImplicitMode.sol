...
abstract contract SignalsImplicitMode is ISignalsImplicitMode {
    ...
    function acceptImplicitRequest(address wallet, Attestation calldata attestation, Payload.Call calldata call)
        external
        view
        returns (bytes32)
    {
    ...
    /// @param attestation The attestation data
    /// @param call The call to validate
    function _validateImplicitRequest(address wallet, Attestation calldata attestation, Payload.Call calldata call)
        internal
        view
        virtual
    {}
